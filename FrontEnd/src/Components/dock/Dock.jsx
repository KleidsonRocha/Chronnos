...
const Dock = () => {
    ...
    return (
        <div className="dock">
            ...
            <button className="dock-button" onClick={() => handleClick("/Anotacoes")}>
                <div className="dock-icon">
                    <svg width={"2rem"} height={"2rem"}>
            ...
            <button className="dock-button" onClick={() => handleClick("/Timeline")}>
                <div className="dock-icon">
                    <svg width={"2rem"} height={"2rem"}>
            ...
            <button className="dock-button" onClick={() => handleClick("/Ajustes")}>
                <div className="dock-icon">
                    <svg width={"2rem"} height={"2rem"}>
